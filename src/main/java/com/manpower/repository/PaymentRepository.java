...
public interface PaymentRepository extends JpaRepository<Payment, Integer> {
    ...
    List<Payment> filterPayments(
            ...
            @Param("paymentMethod") PaymentConstant.PaymentMethod paymentMethod,
            @Param("reference") String reference,
            @Param("paidToType") PaymentConstant.PaidToType paidToType,
            @Param("paidToId") Integer paidToId,
            @Param("invoiceId") Integer invoiceId,
            @Param("status") PaymentConstant.PaymentStatus status,
            @Param("paymentType") PaymentConstant.PaymentType paymentType,
